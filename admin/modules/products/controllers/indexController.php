...
function addAction()
{
	...
	if (!empty($_POST['btn_submit'])) {
		...
		$target_file1 = $target_dir1 . $safeName;
		$uploadOk = 1;
		...
		// With a unique name we should not collide, but still validate size and type
...
function listAction()
{
	...
	////////////////////////////////////////////////////////////////
	// Nếu không có sản phẩm thì hiển thị alert
	if ($numProduct == 0) {
		echo "<script type='text/javascript'> alert('Không có sản phẩm nào');</script>";
	}
